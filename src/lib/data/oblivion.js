export default [{
	...
	note: 'Harvested from reddish-purple colored Mana Bloom, a flower that is normally found only in Mankar Camoran\'s Paradise.',
	...
	note: 'Food, found in many houses and dining halls. It can also be harvested from Blackberry Bushes found on some farms and in the wild in the West Weald.',
	...
	name: 'Boar Meat',
	icon: 'http://images.uesp.net/d/d7/OB-icon-ingredient-Venison_Steak.png',
	note: 'Food, found in several houses and dining halls. Can also be collected from dead Boars, which are randomly found in many outdoors regions.',
	...
	note: 'Collected from Bones Undead, i.e., skeletons and liches, which are commonly found in all undead dungeons. There is also a rare variant listed below.',
	...
	note: 'Food, commonly found in houses and dining halls. Can also be harvested from Carrot Plants, which are found growing on many farms.',
	...
	note: 'Harvested from Clouded Funnel Cap, a mushroom common in mountainous regions (Jerall and Valus Mountains) and Blackwood.',
	...
	note: 'Food, commonly found in houses and dining halls. Can also be harvested from Corn Stalks, which are found growing in many farms.',
	...
	note: 'Collected from dead Mud Crabs, a common nuisance creature found along water shores and in many dungeons.',
	...
	note: 'Harvested from Dragon\'s Tongue Plants, a flower found in a few clusters south of Bravil and more sparsely throughout the West Weald.',
	effects: ['Resist Fire', 'Damage Health', 'Restore Health', 'Fire Shield']
}, {
	name: 'Dreugh Wax',
	icon: 'http://images.uesp.net/c/c0/OB-icon-ingredient-Wax.png',
	note: 'Collected from dead Land Dreughs, a type of monster found outdoors and in monster dungeons at high levels.',
	...
	note: 'Harvested from Dryad\'s Saddel [sic] Polypore, a rare mushroom that only grows in a few select locations.',
	effects: ['Restore Luck', 'Resist Frost', 'Damage Speed', 'Frost Damage']
}, {
	name: 'Ectoplasm',
	icon: 'http://images.uesp.net/c/c0/OB-icon-ingredient-Wax.png',
	note: 'Collected from dead Ethereal Undead, such as ghosts and wraiths, which are commonly found in all undead dungeons.',
	...
	note: 'Food, found in several houses and dining halls. It can also be harvested from Garlic Clusters (treated as plants), which are found in some houses\' basements (especially in Skingrad).',
	...
	note: 'Cannot be harvested or collected. There are a few guaranteed samples, but otherwise it is randomly found on alchemists and in some containers.',
	...
	note: 'Harvested from Grape Vines, which are abundant in several vineyards outside of Skingrad. Can also be found as food in several houses and dining halls.',
	...
	note: 'Harvested from Green Stain Cups, a mushroom that is common in several regions, but particularly abundant in Blackwood.',
	...
	note: 'Harvested from Green Stain Shelf plants, a rare mushroom that is hard to distinguish from the more common Cap variety.',
	...
	note: 'Harvested from Harrada Root plants, which are common in the Planes of Oblivion, but also possibly hostile.',
	...
	note: 'Cannot be harvested, collected, or even bought from alchemists. There are 26 guaranteed samples; otherwise they are found randomly in some containers.',
	...
	note: 'Food, found in several houses and dining halls. It can also be harvested from Leek Plants, which are found growing in a handful of farms.',
	...
	note: 'Food, widely found in houses and dining halls. It can also be harvested from Lettuce Plants, which are found growing on several farms.',
	...
	note: 'Harvested from bluish-purple colored Mana Bloom, a flower that is normally found only in Mankar Camoran\'s Paradise.',
	...
	icon: 'http://images.uesp.net/d/d4/OB-icon-ingredient-Seeds.png',
	note: 'Harvested from Milk Thistle, a flower found throughout mountainous regions (Jerall and Valus Mountains) and in some clusters in the Gold Coast.',
	effects: ['Light', 'Frost Damage', 'Cure Paralysis', 'Paralyze']
}, {
	name: 'Minotaur Horn',
	icon: 'http://images.uesp.net/4/45/OB-icon-ingredient-Minotaur_Horn.png',
	note: 'Collected from dead Minotaurs and Minotaur Lords, two types of monster found outdoors and in monster dungeons.',
	...
	icon: 'http://images.uesp.net/7/7a/OB-icon-ingredient-Root_Pulp.png',
	note: 'Harvested from Morning Glory, a flowering vine found growing on houses and walls in the West Weald and Heartlands.',
	effects: ['Burden', 'Damage Willpower', 'Frost Shield', 'Damage Magicka']
}, {
	name: 'Mort Flesh',
	icon: 'http://images.uesp.net/thumb/3/38/OB-icon-ingredient-Mort_Flesh.png/48px-OB-icon-ingredient-Mort_Flesh.png',
	...
	name: 'Mugwort Seeds',
	icon: 'http://images.uesp.net/d/d4/OB-icon-ingredient-Seeds.png',
	note: 'Cannot be harvested or collected. The only way to obtain them is by purchasing them from alchemy vendors, who may randomly have some in stock.',
	effects: ['Restore Health']
}, {
	name: 'Mutton',
	icon: 'http://images.uesp.net/b/b8/OB-icon-ingredient-Ham.png',
	note: 'Food, found in several houses and dining halls. Can also be collected from some (but not all) dead sheep.',
	...
	note: 'Food, widely found in houses and dining halls. Can also be harvested from Potato Plants, which are found growing on several farms.',
	...
	note: 'Harvested from Primroses, which are flowers occasionally found growing outside various houses and inns.',
	...
	note: 'Food, widely found in houses and dining halls. Can also be harvested from Pumpkin Vines, which are found growing on some farms.',
	...
	note: 'Food, found in many houses and dining halls. Can also be harvested from Radish Plants, which are found growing on several farms.',
	...
	note: 'Harvested from Domica Redwort, a flower found growing in several clusters in Blackwood and sparsely throughout the West Weald.',
	...
	name: 'Root Pulp',
	icon: 'http://images.uesp.net/7/7a/OB-icon-ingredient-Root_Pulp.png',
	note: 'Cannot be harvested or collected. Six guaranteed samples exist; otherwise found randomly in some containers.',
	...
	icon: 'http://images.uesp.net/c/ce/OB-icon-ingredient-Bread.png',
	note: 'Only available from S\'jirra in Faregyl Inn after you have completed The Potato Snatcher. You receive from one to five loaves (based on level) upon completing the quest. You can also return to S\'jirra repeatedly to buy more bread, which can then be used for alchemy.',
	...
	note: 'Harvested from Spiddal Stick plants, which are common in the Planes of Oblivion, but also tend to be hostile.',
	...
	note: 'Food, widely found in houses and dining halls. It can also be harvested from Strawberry Bushes found on some farms and in the wild in the West Weald.',
	...
	icon: 'http://images.uesp.net/c/c0/OB-icon-ingredient-Wax.png',
	note: 'Harvested from both Tiger Lilies and Lily of the Valleys, two types of flower that are most commonly found in the Great Forest.',
	...
	note: 'Technically treated as a food and can be found in a few houses. It can also be harvested from Tobacco Plants, which are found on several farms.',
	...
	note: 'Food, widely found in houses and dining halls. It can also be harvested from Tomato Plants, which are found growing on many farms.',
	effects: ['Restore Fatigue', 'Detect Life', 'Burden', 'Shield']
}, {
	name: 'Troll Fat',
	...
	note: 'Collected from dead Vampires, found in a range of vampire dungeons. There is also a rare variant listed below.',
	effects: ['Silence', 'Resist Disease', 'Frost Damage', 'Invisibility']
}, {
	name: 'Venison',
	icon: 'http://images.uesp.net/d/d7/OB-icon-ingredient-Venison_Steak.png',
	note: 'Food, found in several houses and dining halls. It can also be collected from dead deer, which are animals found outdoors throughout Cyrodiil.',
	...
	note: 'Food, found in several houses and dining halls. It can also be harvested from Watermelon Vines, which grow on a few farms.',
	effects: ['Restore Fatigue', 'Light', 'Burden', 'Damage Health']
}, {
	name: 'Wheat Grain',
	icon: 'http://images.uesp.net/5/50/OB-icon-ingredient-Wheat.png',
	note: 'Food, found in grain sacks in kitchens and pantries. It can also be harvested from Wheat Stalks, which grow on a few farms.',
	...
	note: 'Harvested from Wisp Stalks, a mushroom that is only found growing underground (i.e., in caves and mines).',
	...
	note: 'Harvested from Grummite Egg Mounds and Grummite Egg Sacs, found primarily in Dementia. May also be found on Grummites (25% chance).',
